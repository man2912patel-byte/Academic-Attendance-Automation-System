...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name.trim() || !email.trim() || !username.trim() || !password || !securityAnswer.trim()) {
  ...
  return (
    <div className="flex-grow flex items-center justify-center bg-bg-main px-4 py-12 relative overflow-hidden animate-fade-in">
      <div className="max-w-xl w-full card-premium p-8 shadow-md relative z-10 animate-slide-up">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-extrabold text-text-primary tracking-tight">Create Account</h2>
          <p className="text-text-secondary mt-2 text-sm">Join the automation system today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="block text-text-secondary font-semibold text-xs uppercase tracking-wider" htmlFor="name">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div className="space-y-2">
              <label className="block text-text-secondary font-semibold text-xs uppercase tracking-wider" htmlFor="email">
                Email Address
              </label>
              <input
                id="email"
